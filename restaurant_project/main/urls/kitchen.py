...
from restaurant_project.main.views.kitchen import KitchenHomeView, ItemEditView, ItemCreateView, complete_item, EditMenuView, \
    remove_ingredient, add_ingredient_view, IngredientsView
...
urlpatterns = (
    ...
    path('ingredients/', IngredientsView.as_view(), name='ingredient list view'),
