...
from restaurant_project.main.forms.waiters_forms import CreateOrderDetailsForm, CreateOrderForm
from restaurant_project.main.models import Tables, Orders, FoodAndDrinks, OrderDetails, Categories
